...
sys.path.append(r"C:\Users\aero7\PycharmProjects\nightshade-release-main\data")
...
def main(data_dir, outdir, source_concept, num):
    clip_model = CLIP()
    ...
    random_selected_candidate = random.sample(list(candidate), num)
    ...
    for i, data in enumerate(final_list):
        ...
        pickle.dump(cur_data, open(os.path.join(outdir, "{}.p".format(i)), "wb"))
...
if __name__ == '__main__':
    ...
    odir = r"C:\Users\aero7\PycharmProjects\nightshade-release-main\outdata"
    num = 100
    concept = "dog"
    main(ddir, odir, concept, num)
